    ...
    try {
      if (isLogin) {
        ...
        if (response.ok) {
          ...
          console.log('Scheduling navigation to /posts in 1.5 seconds...');
          
          // Call the auth success callback to update user state
          if (onAuthSuccess) {
          ...
          setTimeout(() => {
            console.log('Executing navigation to /posts after user state update...');
            navigate('/posts');
          }, 1500);
          
          // Fallback navigation using window.location if React Router fails
          setTimeout(() => {
        ...
        if (response.ok) {
          ...
          setSuccess('Registration successful! Redirecting to Posts...');
          console.log('Scheduling navigation to /posts in 1.5 seconds...');
      ...
      <div className="card-body p-4 p-md-5">
        {/* Logo and Title */}
           ...
           <div className="rounded-circle d-inline-flex align-items-center justify-content-center mb-3"
                style={{width: '64px', height: '64px', backgroundColor: 'rgba(0, 168, 132, 0.1)'}}>
             <ChatBubbleLeftRightIcon className="h-4 w-4" style={{color: '#00a884'}} />
           </div>
        ...
        {/* Features */}
                 <div className="mt-4">
           <div className="d-flex align-items-center mb-3" style={{color: '#667781'}}>
             <div className="rounded-circle d-flex align-items-center justify-content-center me-3"
                  style={{width: '20px', height: '20px', backgroundColor: 'rgba(0, 168, 132, 0.1)'}}>
               <svg className="h-4 w-4" style={{color: '#00a884'}} fill="currentColor" viewBox="0 0 20 20">
